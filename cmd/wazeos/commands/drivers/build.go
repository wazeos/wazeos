...
var buildCmd = &cobra.Command{
	Use:   "build [directory]",
	Short: "Build a WASM driver with automatic schema generation",
	Long: `Build a WazeOS WASM driver with automatic schema generation.
...
Examples:
  ...
  wazeos drivers build . --file handler.go`,
