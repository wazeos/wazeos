...
require wazeos_sdk v0.0.0

replace wazeos_sdk => ./wazeos_sdk
`, packageName)
...
// generateDriverSDKTypes creates the local WazeOS WASM SDK for driver development.
...
func generateDriverSDKTypes(driverPath string) []string {
	...
	// Create wazeos_sdk directory
	sdkPath := filepath.Join(driverPath, "wazeos_sdk")
	...
	// 1. Change package name from 'wazeos' to 'wazeos_sdk'
...
// WazeOS kernel's capabilities by handling specific URI patterns.`
	...
	newComment := `// Package wazeos_sdk provides the WazeOS WASM driver SDK.
//
...
// of wazeos that generated it, enabling isolated testing with 'wazeos dev run'.`
	...
	sdkModContent := `module wazeos_sdk
...
const wasmSDKFallback = `// Package wazeos_sdk provides the WazeOS driver SDK types.
//
// This package is auto-generated by 'wazeos driver new' and contains all the
// interfaces and types needed to build a WazeOS driver without requiring the
// core kernel source code.
//
// This copy is specific to this driver and ensures the SDK matches the version
// of wazeos that generated it, enabling isolated testing with 'wazeos dev run'.
package wazeos_sdk
...
//
// The wazeos_sdk package is auto-generated and self-contained.
