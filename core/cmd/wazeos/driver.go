...
// generateDriverSDKTypes creates the local WazeOS SDK types for driver development.
...
func generateDriverSDKTypes(driverPath string) []string {
	...
	// Generate driver.go with all the SDK types
	sdkFile := filepath.Join(sdkPath, "driver.go")
	sdkContent := `// Package wazeos_sdk provides the WazeOS driver SDK types.
//
